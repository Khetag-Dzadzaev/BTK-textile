...
if (amount) {
	...
	if (slider) {
		...
		slider.noUiSlider.on('update', function (values) {
			amount.innerHTML = 'от <strong><span class="amount-dufult1">' + Math.round(values[0]) + '<span class="measurement">г/м<span>2</span></span></strong> -  до <strong><span class="amount-dufult2">' + Math.round(values[1]) + '<span class="measurement">г/м<span>2</span></span></strong>';
...
if (CenAmount) {
	...
	if (CenSlider) {
		...
		CenSlider.noUiSlider.on('update', function (values) {
			CenAmount.innerHTML = 'от <strong><span class="amount-dufult1">' + Math.round(values[0]) + '<span class="measurement">₽ / м<span>2</span></span></strong> -  до <strong><span class="amount-dufult2">' + Math.round(values[1]) + '<span class="measurement">₽ / м<span>2</span></span></strong>';
